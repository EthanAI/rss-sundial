...
public class SundialCalculations {
	 ...
	 *   double longitude: A double within -180 to +180
	 *   int date:         An int of the format YYYYMMDD
	 *   int dstFlag:      0: Hard no on DST 1: Hard Yes 2: Use algorithm isDayLightSavings() to estimate
	 *   
	 * @returns
	 ...
	 *   double longitude: A double within -180 to +180
	 *   int date:         An int of the format YYYYMMDD
	 *   int dstFlag:      0: hard no on dst, 1: hard yes on dst, 2: use the algorithm to estimate
	 *   
	 * @returns
